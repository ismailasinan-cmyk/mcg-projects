...
window.toggleCountry = function (select) {
...
window.loadLGAs = function (stateSelect, selectedLGA = null) {
    var lgaSelect = document.getElementById('lga');
    ...
    if (state && nigeriaData[state]) {
        nigeriaData[state].sort().forEach(function (lga) {
            ...
            if (selectedLGA && lga === selectedLGA) {
...
window.toggleResponsibleInput = function (select) {
